...
app.get('/login', (req, res) => {
    console.log(req.cookies.loginUser, 'req.cookies.loginUser login');
    console.log(req.cookies.password, 'req.cookies.password login');

    if (req.cookies.loginUser && req.cookies.password) {
        res.redirect('/home');
    } else {
            ...
            .then((response1) => {
                uowner = {
                    ...
                    receivedorders: [
                        ...
                        {
                            foodid: foodid,
                            customerid: req.cookies.loginUser,
                        },
                    ],
                };
                axios
...
app.post('/addfood', blob.single('foodpic'), (req, res) => {
    ...
    console.log(req.cookies.loginUser, 'req.userid');
    axios.get('http://localhost:3000/foods/').then((response) => {
        var food = {
...
app.post('/deletefood', (req, res) => {
    ...
    axios
        ...
        .then((response) => {
            res.json({ status: 200, message: 'deleted', succeeded: true });
            // res.redirect('/home');
        });
});
...
app.post('/removefromplaced', (req, res) => {
    axios
        .get('http://localhost:3000/users/' + req.cookies.loginUser)
        .then((response) => {
            uuser = {
                ...response.data,
            ...
            axios
                .put(
                    'http://localhost:3000/users/' + req.cookies.loginUser,
                    uuser
                )
                .then((response) => {
                    console.log('updated user');
